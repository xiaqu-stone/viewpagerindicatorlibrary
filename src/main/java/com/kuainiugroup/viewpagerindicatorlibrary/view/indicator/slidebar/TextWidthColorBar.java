 ...
 */
package com.kuainiugroup.viewpagerindicatorlibrary.view.indicator.slidebar;
...
import com.kuainiugroup.viewpagerindicatorlibrary.view.indicator.Indicator;
...
public class TextWidthColorBar extends ColorBar {
	...
	private int getTextWidth(TextView textView) {
		...
		return bounds.left + bounds.width();//width;
	}
